...
3. [`docs/releases/v0.12.2.md`](releases/v0.12.2.md) and [`docs/MANAGED_PC_SMOKE_TEST.md`](MANAGED_PC_SMOKE_TEST.md) — latest shipped behavior and remaining managed-PC validation.
