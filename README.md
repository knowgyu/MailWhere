...
- **업무 보드 중심**: 보드는 전체/오늘/7일 내/30일 내/기한 미정 필터와 단일 업무 목록으로 활성 항목을 보여줍니다.
- **간단한 카드 액션**: 카드에는 `열기`, `나중에`, `보관`만 드러냅니다. 기한은 날짜/기한 영역을 눌러 바꾸고, 제목은 더블클릭으로 수정합니다.
...
5. 카드에서 `열기`, `나중에`, `보관`으로 정리하고, 제목/기한은 더블클릭 또는 기한 영역에서 바로잡습니다.
